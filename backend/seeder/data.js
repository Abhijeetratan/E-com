export default [
    {
        ...
        category: "Electronics", // Make sure the first letter is capitalized
        seller: "Ebay",
        stock: 50,
        numOfReviews: 32,
        reviews: [],
    ...
    },
    {
        ...
        category: "Headphones", // Make sure the first letter is capitalized
        seller: "Amazon",
        stock: 11,
        numOfReviews: 112,
        reviews: [],
    ...
    },
    {
        ...
        category: "Accessories", // Make sure the first letter is capitalized
        seller: "Amazon",
        stock: 1123,
        numOfReviews: 6,
        reviews: [],
    },
    {
        ...
        category: "Cameras", // Make sure the first letter is capitalized
        seller: "Amazon",
        stock: 131,
        numOfReviews: 222,
        reviews: [],
    },
    {
        ...
        category: "Laptops", // Make sure the first letter is capitalized
        seller: "Amazon",
        stock: 0,
        numOfReviews: 56,
        reviews: [],
    },
    {
        ...
        category: "Food", // Make sure the first letter is capitalized
